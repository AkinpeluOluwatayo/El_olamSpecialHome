...
public class ProgressReportController {
    ...
    public ResponseEntity<List<ProgressReportResponse>> getReportsByChildId(@PathVariable("childId") String childId) {
        List<ProgressReportResponse> reports = reportService.getReportsByChildId(childId);
        return ResponseEntity.ok(reports);
    }

    @GetMapping("/child/{childId}/latest")
    public ResponseEntity<ProgressReportResponse> getLatestReport(@PathVariable("childId") String childId) {
        ProgressReportResponse response = reportService.getLatestReport(childId);
