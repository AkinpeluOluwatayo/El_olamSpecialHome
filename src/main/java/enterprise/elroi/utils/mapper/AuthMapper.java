...
public class AuthMapper {
    ...
    public User toUser(UserRequest request) {
        ...
        // Initialize the list from the model
        user.setChildrenIds(new ArrayList<>());

        // If the Director provided a child ID to link, add it to the list
    ...
    public UserResponse toUserResponse(User user) {
        ...
        // Return the first linked child ID for the parent dashboard view
